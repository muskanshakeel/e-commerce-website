  ...
  return (
    <div className="bg-blue-50 min-h-screen flex flex-col">
      ...
      <header className="bg-gradient-to-r from-blue-800 via-blue-400 to-blue-800 text-white p-12 shadow-2xl relative">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-center font-mono">Shop</h1>
        <p className="text-center mt-4 font-mono text-lg sm:text-xl">
      ...
      <main className="flex-grow p-8">
        ...
        <div className="flex justify-center flex-wrap mb-6">
          <button
            className={`px-4 py-2 mx-2 mb-2 rounded-lg ${
              selectedCategory === "All"
      ...
      <footer className="bg-blue-800 text-blue-200 p-4 mt-12 text-center">
        <p className="text-sm">&copy; 2024 TechTonic. All rights reserved.</p>
      </footer>
    </div>
  );
};
