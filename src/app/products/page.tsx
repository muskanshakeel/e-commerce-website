...
import { Product, products } from '@/app/components/product';

export default function ProductsPage() {
  return (
    <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-gray-100">
        ...
        {products.map((product: Product) => (
          ...
          >
            ...
            <div className="flex flex-col space-y-4">
              ...
              <Link
                href={`/products/${product.id}`} // Linking to individual product pages
